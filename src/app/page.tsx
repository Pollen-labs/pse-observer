...
export default async function Home() {
    ...
    return (
      <main className="p-16">
        ...
        <section className="flex gap-36 justify-center pt-16">
          <div className="">
            <h2 className="text-2xl underline pb-8">EXPORT</h2>
                <a onClick={downloadCSV} className="max-w-72 truncate hover:underline">CSV EXPORT</a>
          </div>
        </section>
  ...
  async function downloadCSV() {
    ...
    const csv = await processCSV(projectNames);
